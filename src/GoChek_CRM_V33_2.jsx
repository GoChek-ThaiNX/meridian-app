...
export default function App() {
  ...
  const view = useMemo(() => ({
    ...
    openingStock: data.openingStock || [], stockMovements: data.stockMovements || [],
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          ...
          <div style={{ padding: 28, flex: 1 }}>
            ...
            {tab === "inventory" && <Inventory
              ...
              openingStock={view.openingStock}
              stockMovements={view.stockMovements}
              stockImportBatches={view.stockImportBatches}
              ...
              user={user}
            />}
            {tab === "fees" && <ImportFees shipments={view.shipments} feePayments={view.feePayments} markets={view.markets} carriers={view.carriers} settings={view.settings} onAdd={onAdd} onEdit={onEdit} onDelete={onDelete} user={user} />}
            ...
            {tab === "market_debts" && <MarketDebts pos={view.pos} shipments={view.shipments} payments={view.payments} factories={view.factories} markets={view.markets} settings={view.settings} products={view.products} warranties={view.warranties} user={user} />}
            ...
            {tab === "payments" && <Payments pos={view.pos} shipments={view.shipments} payments={view.payments} factories={view.factories} openingBalances={view.openingBalances} markets={view.markets} settings={view.settings} onAdd={onAdd} onEdit={onEdit} onDelete={onDelete} user={user} />}
