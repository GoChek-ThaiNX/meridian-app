...
// ============================================================
// GoChek Factory CRM — Phiên bản V32
// ============================================================
...
export default function App() {
  ...
  useEffect(() => {
    (async () => {
      ...
      let saved = await storage.get("crm_data_v31");
      ...
      if (!saved) {
        ...
        if (migratedFrom) console.info(`[GoChek CRM] Migrating data from ${migratedFrom} → v31 schema`);
      }
      ...
      if (saved) {
        ...
        setData(d => ({ ...d, ...saved }));
        // v23: Luôn save lại để fix data cũ + thêm tồn kho
        await storage.set("crm_data_v31", saved);
      } else {
        ...
        setData(init);
        await storage.set("crm_data_v31", init);
      }
      setLoaded(true);
    })();
  }, []);
  ...
  const save = useCallback(async (next) => {
    ...
    setData(synced);
    await storage.set("crm_data_v31", synced);
  }, []);
